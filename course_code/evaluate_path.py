...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred_path", type=str, default="../output/hierarchical_indices/llama3.2/predictions.json")
    ...
    # load predictions
    predictions_file = args.pred_path # os.path.join(output_directory, "predictions.json")
    ...
    output_directory = "/".join(predictions_file.split("/")[:-1])
